...
1. Download the latest release zip file from the [Releases](https://github.com/gametimedev/s4mm-dd-chrome-extension/releases) page.
...
## Usage
Once installed, the extension will automatically activate on supported pages (currently Patreon). When download links are detected, an alternative deeplink download button will appear, enabling seamless integration with the Sims 4 Mod Manager.